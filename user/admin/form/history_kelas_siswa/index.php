         ...
         <div class="box-body">
            <table class="table"  id="example1">
              ...
              <tr>
                ...
                <td>
                  <a href="?a=aktivitas_siswa_kelas&id=<?php echo $dkelas['id_siswa'] ?>&id_kelas=<?php echo $dkelas['id_kelas'] ?>&id_ta=<?php echo $dkelas['id_ta'] ?>&status_ks=<?php echo $dkelas['status_ks'] ?>&semester=1&tingkat=<?php echo $dkelas['tingkat'] ?>&status_ta=<?php echo $dkelas['status_ta'] ?>" class="btn btn-info btn-xs">Ganjil</a>
                  <a href="?a=aktivitas_siswa_kelas&id=<?php echo $dkelas['id_siswa'] ?>&id_kelas=<?php echo $dkelas['id_kelas'] ?>&id_ta=<?php echo $dkelas['id_ta'] ?>&status_ks=<?php echo $dkelas['status_ks'] ?>&semester=2&tingkat=<?php echo $dkelas['tingkat'] ?>&status_ta=<?php echo $dkelas['status_ta'] ?>" class="btn btn-info btn-xs">Genap</a>
                </td>
              </tr>
              <?PHP } ?>
            </table>
