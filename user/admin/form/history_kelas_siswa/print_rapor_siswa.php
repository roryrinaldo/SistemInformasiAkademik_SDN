...
<table style="font-size:12px;border-collapse: collapse;" >
      ...
      <tr>
        <td>Kelas</td>
        <td>'.$d_kelas_siswa['nama_kelas'].'</td>
      </tr>
      <tr>
        <td>Nama Sekolah</td>
        <td>SD Negeri 04 Pulau Payung</td>
      </tr>
      <tr>
        <td>Semester</td>
...
$html .= '
     <tr>
        <td colspan="5" align="center">JUMLAH NILAI = '.$total_nilai.'</td>
      </tr>
     <tr>
        <td colspan="5" align="center">RATA RATA = '.$show_ratarata.'</td>
      </tr>
    </table>
      <br>
';
...
Mengetahui, <br>
Kepala SD Negeri 004 Pulau Payung
 <br> <br> <br> <br>
ROHANI, S.Pd <br>
