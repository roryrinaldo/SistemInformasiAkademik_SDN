...
<?php
  ...
  where a.id_kelas='$idkelas' and b.status_ta='Aktif' and d.username='$username' group by d.status_wali_kelas";
...
?>
  <tr>
    ...
    <td>
      ...
      <a href="?a=data_siswa_kelas_wk&id_kelas=<?php echo $idkelas ?>&id_ta=<?php echo $id_ta ?>&semester=<?php echo $d_semester['semester'] ?>" class="btn btn-info btn-xs"><?php echo $semester_aktif ?></a> 
      <?php } ?>
    </td>
  </tr>
