<div class="box-header with-border">
  ...
  <div class="pull-right">
    <a href="form/guru/print_guru.php" class=" btn btn-info btn-sm" target="_blank">Cetak Data Guru</a>
    <a href="?a=tambah_guru" class=" btn btn-success btn-sm" >Tambah Data</a>
  </div>
