...
$id=$_GET['id'];
 ...
 $qta = mysqli_query($conn, "SELECT * from tahun_ajaran where status_ta='Aktif'");
  ...
  $qcekwk = mysqli_query($conn, "SELECT b.nama_guru, a.status_wali_kelas, a.id_guru, b.nip, a.username, a.id_walikelas as id_wk from wali_kelas a left join guru b on a.id_guru = b.id_guru where a.id_kelas='$id' and a.status_wali_kelas='1'");
...
<div class="pull-right">
      <a href="?a=kelas" class="btn btn-default btn-sm"  >Kembali</a>
    </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="hidden" name="id_wali_kelas" value="<?php echo $id_wk?>">
    ...
    <div class="box-body">
      ...
      if ($jcekwk==1) { ?>
        ...
        // ta = tahun ajaran  
          ...
          $id_ta = $dta['id_ta'];
          if ($jta>0) { ?>
            <a href="" class=" btn btn-warning btn-xs"  data-toggle="modal" data-target="#ganti">Ganti Wali Kelas</a>
            <a href="form/kelas/nonaktifkan_walikelas.php?id_wk=<?php echo $id_wk ?>&id_kelas=<?php echo $id ?>" class=" btn btn-info btn-xs" onclick="return confirm('Nonaktifkan wali kelas.?')">Nonaktifkan Wali Kelas</a>
