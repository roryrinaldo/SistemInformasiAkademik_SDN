    ...
    <div class="box-body">
      ...
      <table class="table">
        ...
        <tr>
          <td>Status</td>
          <td>:</td>
          <?php if($d1['status_siswa']=="Aktif"){ ?><td style="color:green"><?php echo $d1['status_siswa'] ?></td>
            <?php }else{ ?>
              <td style="color:red"><?php echo $d1['status_siswa'] ?></td>
            <?php } ?>
        </tr>
     ...
     <a href="<?php echo $targetback ?>" class="btn btn-default btn-xs"  >Kembali</a>
    </div>
