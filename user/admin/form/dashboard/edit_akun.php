<div class="box-header with-border">
  ...
  <div class="box-tools pull-right">
    <a href="?a=" class="btn btn-default" >Kembali</a>
  </div>
</div>
...
elseif ($level=='Siswa') {
  ...
  $quser = mysqli_query($conn, "SELECT * from wali_kelas where id_guru='$iduser' and status_wali_kelas='1'")or die(mysqli_error());
  $duser = mysqli_fetch_array($quser);
  $username=$duser['username'];
  $password=$duser['password'];
}
